  ...
  return (
    <div className='my-10'>
      <div className='text-center text-3xl py-8'>
        ...
        <p className='w-3/4 m-auto text-xs sm:text-sm md:text-base text-gray-600'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Neque, consectetur possimus veniam omnis velit quaerat soluta, voluptates minus aliquid consequatur</p>
      </div>
       {/* latest products */}
